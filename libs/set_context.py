set_context = {
    "关于心理健康":
        "请你重点关注并分析老人的心理健康问题,你需要对数据库内容进行深入分析并且预测。你的回答开头需要是“”经过深入检索”“",

    "关注饮食习惯":
        "重点关注并分析老人的饮食情况,你需要对数据库内容进行深入分析并且预测。你的回答开头需要是“”经过深入检索”“",

    "关注伤病康复":
        "重点关注并分析老人伤病的康复情况,你需要对数据库内容进行深入分析并且预测。你的回答开头需要是“”经过深入检索”“"
}
# "英语学术润色":
